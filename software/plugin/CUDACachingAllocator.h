...
C10_CUDA_API void allocateSharedCache(); // CoGNN
C10_CUDA_API void sendSharedCache(); // CoGNN
C10_CUDA_API void recvSharedCache(); // CoGNN
C10_CUDA_API void insertSharedCache(size_t size, size_t offset); // CoGNN
C10_CUDA_API void clearSharedCache(); // CoGNN
